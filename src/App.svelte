  ...
  <main class="page-shell">
    ...
    <section class="story-section prose-section footnotes-section">
      ...
      <div class="footnotes">
        ...
        <p id="fn5"><sup>5</sup> In fact, Cuomo probably played spoiler and <a href="https://x.com/PoliticalKiwi/status/1947847745576047055?s=20" target="_blank" rel="noreferrer">center squeezed Brad Lander.</a> <a class="footnote-backref" href="#ref-fn5" aria-label="Back to reference">↩</a></p>
      </div>
    </section>
  </main>
{/if}
